...
\[Avg\ Hit@K\  = \ (1/N)\  \times \ \Sigma\ Hit@Kᵢ\]
...
\[Rumus\ DDCG@K\  = \ \Sigma ᵢ₌₁ᴷ\ (\frac{relᵢ}{log₂}(i + 1))\]
...
MRR = \((\frac{1}{N}\ ) \times \ \Sigma\ RRᵢ\)

Dengan catatan sebagai berikut :

N adalah jumlah total data uji

RRᵢ adalah nilai reciprocal rank untuk data ke-i
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1503}}
  >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1935}}@{}}
\caption{Table 2. Penelitian Terkait}\tabularnewline
\toprule\noalign{}
...
Li et al. (2022) & Semantic Search-Based Supervisor Recommendation System & Menerapkan semantic search untuk rekomendasi supervisor & Universitas Hasyim & Transformer-based Embedding, Semantic Search & Semantic Search-Based Supervisor Recommendation System \\
(Zhang et al. (2021)) & Academic Advisor Recommendation Using Deep Learning & Mengembangkan sistem rekomendasi academic advisor berbasis deep learning & Data dari perlibraryan & BERT Embedding, Deep Learning Classifier & Academic Advisor Recommendation Using Deep Learning \\
\end{longtable}
