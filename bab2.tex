...
Qwen3-Embedding merupakan model embedding dari keluarga Qwen yang dikembangkan oleh Alibaba Cloud \cite{qwen2024embedding}. Varian 0.6B memiliki 600 juta parameter dan dirancang untuk keseimbangan antara performa dan efisiensi komputasi.
...
Dharmawati et al. (\citeyear{dharmawati2020aplikasi}) & Aplikasi Rekomendasi Dosen Pembimbing Skripsi Berbasis TF-IDF dan Cosine Similarity & Membangun aplikasi rekomendasi dosen pembimbing skripsi berbasis pembobotan TF-IDF dan cosine similarity & Data judul skripsi mahasiswa dan keahlian dosen & TF-IDF, Cosine Similarity & Sistem menghasilkan rekomendasi dosen pembimbing yang relevan berdasarkan kemiripan teks judul skripsi dengan profil keahlian dosen \\ \hline

Agustina et al. (\citeyear{agustina2020sistem}) & Sistem Perekomendasi Dosen Pembimbing berdasarkan Relevansi Topik Tugas Akhir menggunakan Metode Okapi BM25 & Membangun sistem rekomendasi dosen pembimbing berdasarkan relevansi topik tugas akhir menggunakan Okapi BM25 & Data tugas akhir mahasiswa dan profil dosen & Okapi BM25 & Metode BM25 menunjukkan kemampuan dalam meranking dosen pembimbing berdasarkan relevansi topik tugas akhir mahasiswa \\ \hline

Hairani \& Mujahid (\citeyear{hairani2022supervisor}) & Recommendations of Thesis Supervisor using the Cosine Similarity Method & Mengembangkan sistem rekomendasi dosen pembimbing tugas akhir berbasis cosine similarity & Data mahasiswa dan profil dosen di institusi pendidikan & Cosine Similarity & Sistem berhasil memberikan rekomendasi dosen pembimbing yang relevan berdasarkan kemiripan profil mahasiswa dan keahlian dosen \\ \hline
...
Falah \& Suryawan (\citeyear{falah2022recommendation}) & Recommendation System to Propose Final Project Supervisors using Cosine Similarity Matrix & Membangun sistem rekomendasi supervisor proyek akhir menggunakan matriks cosine similarity & Data mahasiswa dan data supervisor di institusi pendidikan & Cosine Similarity Matrix & Sistem rekomendasi berbasis matriks cosine similarity berhasil menghasilkan usulan supervisor proyek akhir yang relevan bagi mahasiswa \\ \hline
