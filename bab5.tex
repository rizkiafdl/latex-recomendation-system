...
\begin{enumerate}
    ...
    \item Evaluasi dilakukan terhadap 168 dari 171 mahasiswa menggunakan tiga model \textit{embedding} kandidat. Model terbaik, yaitu \textbf{BAAI/bge-m3} dengan konfigurasi \texttt{extra\_docs=True}, mencapai nilai MRR sebesar 0,711, Hit@5 sebesar 0,929, dan rata-rata peringkat (\textit{avg\_rank}) 2,17 --- jauh di atas \textit{random baseline} (MRR $\sim$0,23). Hasil ini menunjukkan bahwa sistem mampu menempatkan dosen pembimbing yang relevan pada posisi peringkat atas secara konsisten. \textit{Assignment Match Rate} sebesar 0,530 mengindikasikan tingkat keselarasan yang memadai antara rekomendasi sistem dengan data pemetaan historis yang dijadikan \textit{ground truth}.
