...
E-Mail            & : & [email@binus.ac.id] \\
Address           & : & [Alamat Lengkap] \\
Mobile            & : & [Nomor HP] \\
Gender            & : & [Male / Female] \\
Birth Race / Date & : & [Suku] / [Tempat, DD/MM/YYYY] \\
Nationality       & : & Indonesia \\
Marital Status    & : & Single \\
Religion          & : & [Agama] \\
\end{tabular}
...
\noindent
\begin{tabular}{p{4.5cm} p{9.5cm}}
[Tahun] -- [Tahun] & \textbf{[Nama Organisasi]} \\
\end{tabular}
...
\noindent
\begin{tabular}{p{4.5cm} p{9.5cm}}
[Tahun] -- Present & \textbf{[Nama Perusahaan -- Posisi]} \\
\end{tabular}
\end{singlespace}
