...
\caption{Tabel 3. 10 Use Case Kelola Rules Studio}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Elemen
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\bottomrule\noalign{}
\endlastfoot
Use Case Name & Kelola Rules Studio \\
Scenario & EPC mengonfigurasi label semantik melalui Rules Studio \\
Triggering Events & EPC membuka menu Rules Studio \\
Brief Description & Use case ini menjelaskan proses konfigurasi label descriptions (deskripsi, threshold, status niche) dan nilai boost per pasangan supervisor-label \\
Actor & EPC \\
Related Use Case & Trigger Proses Rekomendasi \\
Stakeholder & EPC \\
Pre-condition & EPC telah login, data supervisor telah tersedia \\
Post-condition & Konfigurasi label tersimpan dan digunakan pada run berikutnya \\
Flow Of Events & \begin{minipage}[t]{\linewidth}\raggedright
\begin{tabular}{@{}
...
Brief Description & Use case ini menggambarkan proses inisiasi pipeline rekomendasi lengkap: embedding $\rightarrow$ similarity $\rightarrow$ group bonus $\rightarrow$ capacity planning $\rightarrow$ greedy solver $\rightarrow$ evaluasi \\
Actor & EPC \\
Related Use Case & Import Data Mahasiswa, Kelola Data Faculty Supervisor, Kelola Rules Studio \\
Stakeholder & EPC, Program Studi \\
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.4580}}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.5420}}@{}}
\caption{Tabel 3. 13 Use Case Export Hasil ke Excel}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Elemen
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
Triggering Events & EPC menekan tombol export pada halaman detail run \\
Brief Description & Sistem menghasilkan file Excel berisi 3 sheet: recommendations, summary kapasitas, dan evaluation metrics \\
Actor & EPC \\
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.4580}}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.5420}}@{}}
\caption{Tabel 3. 14 Use Case Logout}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Elemen
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.4580}}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.5420}}@{}}
\caption{Tabel 3. 15 Use Case Lihat Dashboard}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Elemen
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
