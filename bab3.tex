...
\begin{longtable}{|p{1cm}|p{11.5cm}|}
\caption{Tabel 3.1 Analisis Kebutuhan Fungsional} \label{table:tab3.1} \\
\hline
\textbf{No} & \textbf{Kebutuhan Fungsional} \\
\hline
\endfirsthead
\endhead
\hline
...
\begin{longtable}{|p{1cm}|p{11.5cm}|}
\caption{Tabel 3.2 Analisis Kebutuhan Non-Fungsional} \label{table:tab3.2} \\
\hline
\textbf{No} & \textbf{Kebutuhan Non-Fungsional} \\
\hline
\endfirsthead
\endhead
\hline
...
Setiap faculty supervisor direpresentasikan dalam bentuk satu atau lebih dokumen teks yang bersifat unik. Dokumen teks tersebut dibentuk dengan menggabungkan field-field tekstual dari masing-masing sumber data. Pada penelitian ini terdapat dua sumber data utama untuk merepresentasikan faculty supervisor: kata kunci kompetensi yang dikelola secara manual oleh EPC melalui antarmuka Supervisor Studio, serta data historis bimbingan mahasiswa yang mencakup posisi dan topik magang, nama perusahaan, dan kategori program mahasiswa yang pernah dibimbing oleh faculty supervisor tersebut.
...
\caption{Tabel 3.3 Representasi Data Faculty Supervisor} \label{table:tab3.3} \\
\hline
\textbf{Entitas} & \textbf{Atribut} & \textbf{Sumber} & \textbf{Deskripsi Singkat} \\
\hline
\endfirsthead
\endhead
\hline
\endfoot
Faculty supervisor & Kata kunci kompetensi & Supervisor Studio (input manual EPC) & Kata kunci profil keahlian dosen yang dikelola EPC melalui antarmuka sistem \\
\hline
Faculty supervisor & Informasi posisi magang & Data historis bimbingan mahasiswa & Posisi dan topik magang mahasiswa yang pernah dibimbing \\
\hline
Faculty supervisor & Perusahaan & Data historis bimbingan mahasiswa & Nama perusahaan mahasiswa yang pernah dibimbing \\
\hline
Faculty supervisor & Kategori program mahasiswa & Data historis bimbingan mahasiswa & Kategori atau jalur program mahasiswa yang pernah dibimbing \\
\hline
\end{longtable}

Dalam implementasinya, kata kunci kompetensi selalu tersedia karena dikelola langsung oleh EPC. Data historis bimbingan bersifat opsional dan hanya digunakan apabila fitur \textit{extra docs} diaktifkan pada saat proses rekomendasi dijalankan. Apabila fitur tersebut tidak diaktifkan, representasi faculty supervisor hanya dibentuk dari kata kunci kompetensi yang tersedia di Supervisor Studio.

\subsection{Pemrosesan Data Mahasiswa}\label{pemrosesan-data-mahasiswa}

Data mahasiswa yang dimasukkan oleh EPC melalui sistem mencakup tiga field tekstual: posisi dan topik magang, nama perusahaan mitra, serta kategori program mahasiswa. Ketiga field tersebut digabungkan menjadi satu teks input dengan pemisah berupa \textit{whitespace} untuk merepresentasikan karakteristik mahasiswa secara menyeluruh. Urutan penggabungan ditetapkan secara konsisten, yaitu posisi dan topik terlebih dahulu, diikuti nama perusahaan, kemudian kategori program. Apabila terdapat field yang tidak tersedia, field tersebut tidak disertakan tanpa mengubah urutan penggabungan.
...
\caption{Tabel 3.4 Pemrosesan Data Mahasiswa} \label{table:tab3.4} \\
\hline
\textbf{Entitas} & \textbf{Atribut} & \textbf{Digunakan sebagai Teks} & \textbf{Deskripsi} \\
\hline
\endfirsthead
\endhead
\hline
...
\caption{Tabel 3.5 Struktur Data Knowledge Base} \label{table:tab3.5} \\
\hline
