...
% TODO: tambahkan gambar 1.1 (grafik pertumbuhan mahasiswa) — tidak tersedia di docx
% \begin{figure}
% \centering
% \includegraphics[width=0.8\linewidth]{pic/NAMA-GAMBAR}
% \caption{Pertumbuhan jumlah mahasiswa dari tahun ke tahun di XYZ University}
% \label{fig:fig1.1}
% \end{figure}
