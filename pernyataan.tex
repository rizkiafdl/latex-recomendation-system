...
\noindent Dengan ini saya, \\
    ...
    \renewcommand{\arraystretch}{1} % Increases row height by 50%
    \begin{tabular}{ll}
    \indent Nama & :\hspace*{0.2 cm}\penulis \\
    \indent NIM & :\hspace*{0.2 cm}\nim \\
    \indent Judul Skripsi & :\hspace*{0.2 cm} \Judul \\
    \end{tabular}
